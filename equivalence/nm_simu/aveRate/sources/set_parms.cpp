...
#ifdef PARM_INF_2D
	g_Spd.BETA_INF_1D = 2.3;
	g_Spd.ALPHA_INF_1D = 2.0;							//1D	//or 0.5, 1.0, 2.0, 4.0		//0.5 + double(g_taskNum) * 0.5;
	g_Spd.ALPHA_INF_2D = 0.5 + double(g_taskNum) * 0.5;	//2D
#elif defined PARM_INF_1D
	g_Spd.BETA_INF_2D = 1.425815;						 	//2D		
	//infect
	if (g_taskNum == 0)
	{
